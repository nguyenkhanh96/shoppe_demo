...
import no_cart from '../../assets/img/no_cart.png';
      ...
      <div className="grid wide">
        <nav className="header__navbar hide-on-mobile-tablet">
          <ul className="header__navbar-list">
            <li className="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
              ...
              <div className="header__qr">
                ...
                <div className="header__qr-apps">
                  <a href="true" className="header__qr-link">
                    <img
                      src={google_play}
                      alt="Google Play"
            ...
            <li className="header__navbar-item">
              ...
              <a href="true" className="header__navbar-icon-link">
          ...
          <ul className="header__navbar-list">
                ...
                <ul className="header__notify-list">
                  ...
                  <li className="header__notify-item header__notify-item--viewed">
                    <a href className="header__notify-link">
                      ...
                      <div className="header__notify-info">
                        <span className="header__notify-name">
                          Mỹ phẩm Ohui chính hãng nguồn gốc các sản phẩm Ohui
                        </span>
                        <span className="header__notify-descriotion">
                          Mô tả mỹ phẩm Ohui chính hãng
                        </span>
            ...
            <li className="header__navbar-item header__navbar-user">
              <img
                src="https://cf.shopee.vn/file/78ee52da6f312a11ce271e152342a9b0_tn"
                alt=""
              ...
              <ul className="header__navbar-user-menu">
                ...
                <li className="header__navbar-user-item">
                  <a href="true">Địa chỉ của tôi</a>
                </li>
                <li className="header__navbar-user-item">
                  <a href="true">Đơn mua</a>
                </li>
                <li className="header__navbar-user-item header__navbar-user-item--separate">
                  <a href="true">Đăng xuất</a>
                </li>
              </ul>
            </li>
          </ul>
        ...
        <div className="header-with-search">
          <div className="mobile__item">
            <label htmlFor="mobile-bars-checkbox" className="header-bars">
              <i className="header-bars-icon fa-solid fa-bars"></i>
            </label>
            ...
            <input
              type="checkbox"
              hidden
              className="header__nav-bars-checkbox"
              id="mobile-bars-checkbox"
            />

            <div className="header__nav-bars">
              <ul className="header__nav-bar-item">
                <li className="header__nav-bar-choose">
                  <a href="true" className="header__nav-bar-choose-link">
                    Home
                  </a>
                </li>
                <li className="header__nav-bar-choose">
                ...
                <li className="header__nav-bar-choose">
                  <img
                    src="https://cf.shopee.vn/file/78ee52da6f312a11ce271e152342a9b0_tn"
                    alt=""
                    className="header__nav-bar-choose-img"
                  />
                  <a href="true" className="header__nav-bar-choose-link">
                    Đăng nhập
                  </a>
              ...
              <div className="header__search-history">
                ...
                <ul className="header__search-history-list">
                  <li className="header__search-history-item">
                    <a href="true">Kem dưỡng da</a>
                  </li>
                  <li className="header__search-history-item">
                    <a href="true">Kem trị mụn</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="header__cart">
            <div className="header__cart-wrap">
              ...
              <div className="header__cart-list">
                ...
                <h4 className="header__cart-heading-have-cart">
                  Sản phẩm đã thêm
                </h4>
                    ...
                    <div className="header__cart-item-info">
                      <div className="header__cart-item-head">
                        <h5 className="header__cart-item-name">
                          Bộ kem đặt trị vùng mắt Bộ kem đặt trị vùng mắt Bộ kem
                          đặt trị vùng mắt Bộ kem đặt trị vùng mắt Bộ kem đặt
                          trị vùng mắt Bộ kem đặt trị vùng mắt Bộ kem đặt trị
                          vùng mắt Bộ kem đặt trị vùng mắt{" "}
                        </h5>
                      ...
                      <div className="header__cart-item-body">
                        ...
                        <span className="header__cart-item-remote">Xoá</span>
                      </div>
                    </div>
                  </li>
